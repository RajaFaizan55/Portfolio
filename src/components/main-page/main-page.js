...
const MainPage = () => {
  return (
    <div>
      <div>
        <div
          // style={{ height: "89.5vh", overflowY: "auto" }}
          className=" wraper  bg-white flex-1 2xl:h-89.5vh 2xl:overflow-y-auto  rounded-md py-5 px-10 justify-start "
        >
          ...
          <ul className="list-disc ml-6 leading-10 mb-7">
            <li>
              Designed and developed front-end webpages using JavaScript, HTML5,
          ...
          <span>
            ...
            creative way. I created websites for many famous brand companies.
          </span>
